...
def test_hotkeys_tab_clear_disabled_for_required_bindings(qapp):
    ...
    command_palette can be cleared. Test via the form: walk each row, find
    the QPushButton labelled 'Clear', confirm enabled state matches."""
    ...
    # push_to_talk and command_palette can be cleared.
